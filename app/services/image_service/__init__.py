...
This module provides classes and utilities for generating images for Instagram carousels.
It offers different implementations with varying levels of features and error handling.
...
Functions:
    get_image_service: Factory function to create the appropriate service instance
    get_default_image_service: Returns the default service (for backward compatibility)
"""
